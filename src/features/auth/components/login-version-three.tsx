...
function TechnicalArtwork() {
  return (
    <div className="relative hidden min-h-0 items-center justify-center xl:flex" aria-hidden="true">
      <svg viewBox="0 0 820 720" className="h-auto max-h-[690px] w-full max-w-[820px]">
        <defs>
        ...
        <g fill="none" stroke="#183126">
          <circle cx="410" cy="350" r="236" strokeOpacity=".14" strokeWidth="1" />
          <circle cx="410" cy="350" r="208" strokeOpacity=".22" strokeWidth="1.2" />
          <circle cx="410" cy="350" r="176" strokeOpacity=".36" strokeWidth="1.4" />
          ...
          <circle cx="410" cy="350" r="220" stroke="#7e846f" strokeDasharray="108 42 64 38" strokeWidth="8" opacity=".58" transform="rotate(-24 410 350)" />
          <circle cx="410" cy="350" r="184" stroke="#183126" strokeDasharray="144 70 38 72" strokeWidth="5" opacity=".72" transform="rotate(38 410 350)" />
          <circle cx="410" cy="350" r="151" stroke="#a9852e" strokeDasharray="38 92 18 84" strokeWidth="3" opacity=".72" transform="rotate(-58 410 350)" />
        </g>
        ...
        <g fill="none" stroke="#183126" strokeLinecap="round" strokeLinejoin="round">
          <path d="M174 222h54l38 38h48l31 31" strokeOpacity=".42" strokeWidth="1.2" />
          <path d="M147 470h70l30-30h57l31-31" strokeOpacity=".52" strokeWidth="1.2" />
          <path d="M501 254h67l42-42h77v-55" strokeOpacity=".4" strokeWidth="1.1" />
          <path d="M514 426h52l48 48h72v76" strokeOpacity=".5" strokeWidth="1.2" />
        ...
        <g fill="#a9852e" stroke="#ece8dc" strokeWidth="3">
          <circle cx="174" cy="222" r="5" />
          <circle cx="147" cy="470" r="5" />
          <circle cx="687" cy="157" r="5" />
          <circle cx="686" cy="550" r="5" />
        ...
        <g stroke="#183126" fill="none" strokeLinecap="round">
          <path d="M365 292c15-24 76-31 94-5 14 20-2 37-34 49l-35 13c-30 11-44 31-31 55 18 33 81 27 101-2" strokeWidth="8" strokeOpacity=".82" />
          <path d="M367 286c21-17 69-21 89 2M362 410c25 19 73 16 96-5" strokeWidth="1.2" strokeOpacity=".38" />
...
export function LoginVersionThree({
  ...
  return (
    <main className="relative min-h-svh overflow-hidden bg-[#ece8dc] text-[#17231d] selection:bg-[#a9852e] selection:text-white lg:grid lg:grid-cols-[120px_minmax(0,1fr)]">
      <aside className="relative z-20 flex h-20 items-center border-b border-[#a9852e]/35 bg-[#183126] px-4 text-[#ece8dc] lg:h-svh lg:flex-col lg:border-b-0 lg:border-r lg:px-0 lg:py-7">
        <div className="pointer-events-none absolute inset-0 opacity-20" aria-hidden="true">
          <div className="absolute inset-x-3 top-1/2 h-px bg-[#c9a348]" />
          <div className="absolute bottom-8 left-1/2 top-36 w-px bg-[repeating-linear-gradient(to_bottom,#c9a348_0_2px,transparent_2px_11px)] lg:block" />
        </div>

        <img src={ctaLogo} alt="Brasão do 4º Centro de Telemática de Área" className="relative h-14 w-12 object-contain lg:h-[100px] lg:w-[82px]" />
        <div className="relative ml-3 lg:ml-0 lg:mt-10 lg:[writing-mode:vertical-rl] lg:rotate-180">
          <p className="font-heading text-xl font-bold tracking-[.16em] lg:text-lg lg:text-[#c9a348]">SAGEP</p>
          <p className="text-[8px] uppercase tracking-[.14em] text-[#c9bea2] lg:mt-3 lg:hidden">4º Centro de Telemática de Área</p>
        </div>
        <div className="relative ml-auto lg:mb-0 lg:mt-auto">
          <div className="lg:hidden"><PublicSystemStatus /></div>
          <img src={engineeringInsignia} alt="" aria-hidden="true" className="hidden size-[82px] object-contain lg:block" />
        </div>
      </aside>
      ...
      <div className="relative z-10 flex min-h-[calc(100svh-5rem)] min-w-0 flex-col lg:min-h-svh">
        ...
        <div className="relative z-10 grid flex-1 items-center gap-10 px-5 py-10 sm:px-8 lg:px-12 lg:py-8 xl:grid-cols-[minmax(390px,500px)_minmax(520px,1fr)] xl:gap-12 2xl:px-20">
          <section className="mx-auto w-full max-w-[500px] xl:mx-0">
