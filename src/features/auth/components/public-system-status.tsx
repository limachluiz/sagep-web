...
export function PublicSystemStatus() {
  ...
  return (
    <div
      className={`flex items-center gap-2 rounded-md border bg-[#07120f]/70 px-3 py-2 text-[8px] font-semibold uppercase tracking-[.16em] backdrop-blur-md sm:px-4 sm:text-[9px] sm:tracking-[.2em] ${presentation.containerClass}`}
      role="status"
      aria-live="polite"
