...
export function UsersPage() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (payload: UserFormPayload) => {
      ...
      const updated = await usersService.update(selected.id, { name: payload.name, email: payload.email, rank: payload.rank, cpf: payload.cpf })
