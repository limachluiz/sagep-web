...
export function AtasPage() {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground">Valor registrado nesta página</CardTitle></CardHeader><CardContent className="flex items-center gap-3"><CircleDollarSign className="size-6 text-primary" /><p className="text-xl font-semibold">{money(totalAmount)}</p></CardContent></Card>
    </div>
