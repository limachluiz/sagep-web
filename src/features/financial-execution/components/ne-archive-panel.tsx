...
type Entry = { origin: string; externalCode: string; importedAt: string; updatedAt: string; snapshot: { document: unknown; related: unknown; fetchedAt: string }; financial: { issuedAt: string | null; creditNotes: string[] } }
