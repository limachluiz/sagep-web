...
type Financial = { current: number | null; liquidated: number | null; paid: number | null; status: string; incomplete?: boolean; inconsistent?: boolean }
type Snapshot = { document: unknown; related: unknown; fetchedAt?: string; financial?: { documents: Array<{ code: string; phase: number; amount: number | null; error?: string; subitems: Json[] }> } }
