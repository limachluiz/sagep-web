  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="max-h-[90vh] sm:!max-w-2xl overflow-y-auto">
      ...
      <div className="space-y-5">
        ...
        {!preview && <div className="rounded-xl border border-dashed p-5 text-sm text-muted-foreground"><p className="font-medium text-foreground">Consulta oficial obrigatória</p><p className="mt-1">Serão usados a UASG e a Gestão configuradas para a organização. O token permanece protegido no backend.</p></div>}
