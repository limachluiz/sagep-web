...
describe("ProjectWorkflowProgress", () => {
  it("calcula o avanço pelas etapas do workflow", () => {
    ...
    expect(getWorkflowProgress("OS_LIBERADA", "EM_ANDAMENTO")).toBe(50)
  ...
  it("destaca a etapa atual e a próxima ação", () => {
    ...
    expect(screen.getByRole("progressbar", { name: /progresso do projeto/i })).toHaveAttribute("aria-valuenow", "25")
  })
