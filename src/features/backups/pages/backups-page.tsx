...
export function BackupsPage() {
  ...
  const removeMutation = useMutation({
    ...
    onSuccess: () => { toast.success("Backup excluído."); void refresh() },
    onError: (error) => toast.error(error.message),
  })
